...
# Get initial dice rolls for the user
...
# get initial dice rolls for the computer
computer_first = two_rolls("Computer")
computer_points = computer_first[0]

# print(f"The computer rolled a total of {computer_points} points.")
...
while computer_points < 13 and user_points < 13:
    ...
    if roll_again == "yes":
        ...
        #if the user goes over 13 points, tell them that they lose and set points to 0
        if user_points > 13:
    ...
    # check if computer hasnt gone over
